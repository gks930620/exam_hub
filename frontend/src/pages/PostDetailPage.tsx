...
export default function PostDetailPage() {
  ...
  if (err && !post) return <div className="k-alert k-alert--err">{err}</div>;
  if (!post) return <div className="k-empty state">불러오는 중…</div>;
  ...
  return (
    <>
      ...
      <div className="comment-list">
        {comments.length === 0 && <div className="k-empty state">첫 댓글을 남겨 보세요.</div>}
        {comments.map((c) => (
