...
public final class DataSourceCatalog {
    ...
    public static List<Entry> entries() {
        return List.of(
                ...
                new Entry("중국어", "HSK 중국어능력시험(필기)",
                        Mode.AUTO, "HSK한국사무국",
                        "https://www.hsk.or.kr/?c1=100&c2=002&c3=002&c4=006",
                        "어학시험 → HSK IBT → 시험일정 (그 해 일정이 표 하나에)",
                        "월 1회 내외",
                        "2026-09-08 실측 검증. ⚠️ 시험일자에 <b>연도가 없어</b> 제목의 연도를 붙입니다. 1월 시험은 전해 11월에 접수하므로 접수 칸에 적힌 연도를 따로 읽습니다."),
                new Entry("중국어(회화)", "HSKK 중국어 회화시험",
                        Mode.MANUAL, "HSK한국사무국",
                        "https://www.hsk.or.kr/",
                        "어학시험 → HSKK → 시험일정",
                        "월 1회 내외",
                        "같은 사이트의 다른 탭입니다. 표 구조를 따로 확인해야 해서 아직 수기입니다 — HSK 필기는 자동입니다."),
