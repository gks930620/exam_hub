    ...
    public static List<Entry> entries() {
        return List.of(
                ...
                new Entry("IT·데이터", "빅데이터분석기사, ADP·ADsP, SQLP·SQLD, DAP·DAsP",
                        Mode.MANUAL, "한국데이터산업진흥원",
                        "https://www.dataq.or.kr/www/accept/schedule.do",
                        "자격검정 → 시험일정 (연간 일정표 한 장에 7종이 다 있습니다)",
                        "종목별 연 2~4회",
                        "⚠️ <b>자동 수집을 껐습니다</b>(2026-09-09). 이 시행처의 robots.txt 가 <b>전체 차단</b>인데(Disallow: /) 그동안 매일 긁고 있었습니다 — 우리가 정한 규칙을 우리가 어기고 있었습니다. 파서는 멀쩡하니 지우지 않았고, 허락을 받거나 공식 API 를 찾으면 <code>scrape.dataq.enabled=true</code> 로 되살아납니다. 이미 받아 둔 일정은 그대로 있고, 새 회차만 수기입니다. ⚠️ 빅데이터분석기사는 국가기술자격인데 큐넷에 없어 여기서만 들어옵니다."),
                ...
                new Entry("금융(보험)", "보험심사역(AIU), 보험심사역(CIU)",
                        Mode.AUTO, "보험연수원",
                        "https://www.in.or.kr/main/certification/aiu/schedule.do",
                        "보험심사역 → 시험일정 (개인·기업 부문이 같은 날이라 페이지가 하나입니다)",
                        "연 2회",
                        "2026-09-08 실측 검증. 표가 가로로 눕혀 있어(회차가 열) 세워서 읽습니다. 접수 마감일은 연도를 생략해 시작의 연도를 이어받습니다."),
                ...
                new Entry("한자(대한검정회)", "대한검정회 한자 준1급, 대한검정회 한자 2급",
                        Mode.AUTO, "대한검정회",
                        "https://www.hanja.ne.kr/index_original.asp",
                        "첫 화면의 시험일정 안내 — 다음 회차 하나가 실립니다",
                        "연 4회",
                        "2026-09-08 실측 검증. ⚠️ 이 화면은 담당자가 손으로 고치는데 <b>옛 문구를 지우지 않고 주석으로 감싸 둡니다</b>(2024년 접수기간이 그대로 남아 있었습니다). 파서가 주석을 먼저 걷어냅니다 — 안 그러면 지난해 날짜가 올해 접수기간으로 들어갑니다."),
                new Entry("회계·세무", "전산세무 1·2급, 전산회계 1·2급",
                        Mode.AUTO, "한국세무사회",
                        "https://license.kacta.or.kr/web/home/Default.aspx",
                        "첫 화면의 시험일정 표 (사이트가 프레임셋이라 몸통 주소를 직접 읽습니다)",
                        "연 6회",
                        "2026-09-08 실측 검증. 표에 <b>연도도 회차 번호도 없어</b> 연도는 올해로 읽고, 회차는 지어내지 않습니다(시험일을 내부 키로 쓰고 화면엔 회차로 안 보입니다). 시행처는 공지에서 \"제128회\"라고 부르지만 그건 공지 제목에서 역산해야 해서, 공지 목록이 바뀌면 회차가 통째로 어긋납니다."),
                new Entry("사무·IT(DIAT)", "DIAT 디지털정보활용능력",
                        Mode.AUTO, "한국정보통신진흥협회(KAIT)",
                        "https://www.ihd.or.kr/guidecert.do",
                        "시험일정 — 그 해 14회차가 표 하나에 다 있습니다",
                        "연 14회",
                        "2026-09-08 실측 검증. 자격은 KAIT 것이고 검정 시행·일정 공개는 한국정보통신인력개발센터(ihd.or.kr)가 합니다. ⚠️ 표에 <b>연도가 바뀌는 자리에만</b> 적혀 있고(' 25), 12월 접수 → 이듬해 시험인 회차가 여럿이라 앞뒤로 연도를 넘겨 읽습니다. <b>인터넷정보관리사는 이 표에 없어</b> 아직 수기입니다."),
                new Entry("경제·경영", "매경TEST 경제경영이해력시험",
                        Mode.AUTO, "매일경제신문",
                        "https://exam.mk.co.kr/online_main.php?MM=2",
                        "시험일정 — 그 해 회차가 표 하나에 다 있습니다",
                        "연 6회",
                        "2026-09-08 실측 검증. ⚠️ 날짜와 요일 사이에 <b>눈에 안 보이는 문자</b>(폭 없는 공백)가 끼어 있어 요일은 안 보고 숫자만 읽습니다. 주니어 매경TEST 는 마스터에 없어 넣지 않습니다."),
                new Entry("경제·경영", "TESAT 경제이해력검증시험",
                        Mode.AUTO, "한국경제신문",
                        "https://www.tesat.or.kr/app.frm.general.exam/schedule.regular",
                        "시험일정 — 그 해 회차가 표 하나에 다 있습니다",
                        "연 6회",
                        "2026-09-08 실측 검증. 주니어 TESAT 은 별도 페이지이고 마스터에 없어 넣지 않습니다."),
                ...
                new Entry("중국어(필기)", "HSK 중국어능력시험(필기)",
                        Mode.AUTO, "HSK한국사무국",
                        "https://www.hsk.or.kr/?c1=100&c2=002&c3=002&c4=006",
                        "어학시험 → HSK IBT → 시험일정 (그 해 일정이 표 하나에)",
                        "월 1회 내외",
                        "2026-09-21 자동으로 바뀌었습니다. 예전엔 시행처가 우리 수집기를 거부했는데(302 → /error.htm, 2026-09-09) 지금은 우리 User-Agent 그대로 200 을 주고 robots.txt 도 <b>Allow: /</b> 입니다. 브라우저인 척하지 않았습니다. 표에 연도가 없어 수집기가 채워 넣습니다 — 1월 시험의 접수는 전해입니다."),
                new Entry("중국어(회화)", "HSKK 중국어 회화시험",
                        Mode.MANUAL, "HSK한국사무국",
                        "https://www.hsk.or.kr/",
                        "HSKK 메뉴 — 주소를 아직 못 찾았습니다",
                        "연 다회",
                        "필기(HSK)는 자동인데 <b>회화(HSKK)는 같은 표에 없습니다</b>. 같은 사무국이지만 메뉴가 따로고, 일정표 주소를 아직 못 찾았습니다(2026-09-21 재조사). 찾으면 필기와 같은 파서로 붙습니다 — 설계/시험데이터/07_못붙인_시행처.md 참고."),
                ...
                new Entry("일본어", "JLPT 일본어능력시험",
                        Mode.MANUAL, "JEES / 국제교류기금",
                        "https://www.jlpt.or.kr/html/",
                        "첫 화면의 접수·시험일 안내",
                        "연 2회(7월·12월)",
                        "⚠️ 시행처가 <b>우리 수집기를 거부합니다</b> — 브라우저가 아닌 User-Agent 로 요청하면 302 로 튕깁니다(robots.txt 조차 403). 2026-09-09 실측. 예전엔 '자동'이라고 적혀 있었지만 실제로는 매번 0건이었습니다. 브라우저인 척하면 읽히지만 그건 명시적 차단을 우회하는 것이라 하지 않습니다. <b>연 2회뿐이라 수기가 쌉니다</b> — 접수를 놓치면 반년을 기다리는 시험이니 꼭 넣어 주세요."),
