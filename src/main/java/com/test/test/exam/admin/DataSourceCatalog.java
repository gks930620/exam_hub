...
public final class DataSourceCatalog {
    ...
    public enum Mode {
        ...
        AUTO("자동 수집", "서버가 주기적으로 가져옵니다. 손으로 고쳐도 다음 수집 때 덮어써집니다."),
    ...
    public static List<Entry> entries() {
        return List.of(
                ...
                new Entry("보건·의료", "간호사, 물리치료사, 임상병리사, 방사선사, 영양사 등",
                        Mode.MANUAL, "한국보건의료인국가시험원(국시원)",
                        "https://www.kuksiwon.or.kr/",
                        "시험일정 → 연간 시험일정",
                        "연 1~2회",
                        "직종별로 일정이 다릅니다. 연간 일정표가 PDF 로 나오니 그걸 보고 넣습니다."),
                ...
                new Entry("국가기술자격", "613종 (국가기술자격 513 + 국가전문자격 100)",
                        Mode.AUTO_PENDING, "한국산업인력공단(큐넷)",
                        "https://www.q-net.or.kr/",
                        "공공데이터포털 API (자격 시험일정 조회 서비스)",
                        "연 3~4회",
                        "API 키·호출 전략 확인 완료(종목별 613콜 — 일 1,000회 한도 안). 종목 613종은 이미 마스터에 적재했고, 일정 연동만 남았습니다. ⚠️ 국가기술자격이라고 전부 여기 있는 건 아닙니다 — 위 '큐넷 아님' 항목을 보세요."),
                new Entry("영어", "TOEIC",
                        Mode.AUTO, "YBM",
                        "https://m.exam.toeic.co.kr/receipt/examSchList.php",
                        "모바일 접수일정 페이지 (PC 페이지는 에러가 납니다)",
                        "월 2~3회",
                        "스크래핑 검증 완료(12회차). 기본 off 이며 --scrape.enabled=true 로 켭니다."),
