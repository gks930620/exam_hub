...
public final class DataSourceCatalog {
    ...
    public static List<Entry> entries() {
        return List.of(
                ...
                new Entry("한자", "한자능력검정(어문회) / 대한검정회 한자",
                        Mode.MANUAL, "한국어문회 / 대한검정회",
                ...
                new Entry("금융", "보험계리사, 손해사정사, 보험중개사",
                        Mode.AUTO_PENDING, "금융감독원",
                        "https://www.fss.or.kr/",
                        "업무자료 → 자격시험 공고",
                        "연 1~2회",
                        "공고 페이지에 날짜가 그대로 보여 스크래퍼 예정(05 문서 C 표). 붙기 전까지는 수기로 넣어도 된다."),
                ...
                new Entry("영어(기타)", "G-TELP, TOEIC Speaking/Writing",
                        ...
                        "시험일정",
                        "월 다회",
                        "G-TELP 는 스크래핑이 막혀 있어(봇 차단) 당분간 수기입니다. TOEIC 스크래퍼는 정기 토익 일정만 읽습니다."),
