...
public final class DataSourceCatalog {
    ...
    public static List<Entry> entries() {
        return List.of(
                ...
                new Entry("중국어", "HSK 중국어능력시험(필기), HSKK 중국어 회화시험",
                        Mode.MANUAL, "HSK한국사무국",
                        "https://www.hsk.or.kr/?c1=100&c2=002&c3=002&c4=006",
                        "어학시험 → HSK IBT → 시험일정 (그 해 일정이 표 하나에)",
                        "월 1회 내외",
                        "⚠️ 시행처가 <b>우리 수집기를 거부합니다</b> — 브라우저가 아닌 User-Agent 로 요청하면 /error.htm 으로 302 를 보냅니다(2026-09-09 실측). 브라우저인 척하면 읽히지만 그건 명시적 차단을 우회하는 것이라 하지 않습니다. 표는 브라우저로 열면 잘 보이니 수기로 넣어 주세요."),
